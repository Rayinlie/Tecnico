...
<form action="alteraruser2.php" method="POST">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="inputName4" class="text-dark font-weight-light h5">Nome</label>
  ...
  <div class="form-group">
    <label for="inputEmail" class="text-dark font-weight-light h5">Email</label>
  ...
  <div class="form-group">
    <label for="inputEmail" class="text-dark font-weight-light h5">Senha</label>
