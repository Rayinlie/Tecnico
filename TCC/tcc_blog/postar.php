...
<div class="container-fluid">
		<div class="container">
			<div class="formBox">
				<form method="POST" action="postando.php" class="text-dark">
						<div class="row">
							<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-6">
							<div class="inputText text-dark h4"> Titulo do Post</div>
								<div class="inputBox ">
									<input type="text" name="titulo" class="input text-dark">
								</div>
							</div>

							<div class="col-sm-6">
							<div class="inputText text-dark h4">Assunto(tag)</div>
								<div class="inputBox text-dark">
									<input type="text" name="tag" class="input text-dark">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
							<div class="inputText text-dark h4">Conteúdo</div>
								<div class="inputBox text-dark">
									<textarea class="input height=200px text-dark" name="postagem"></textarea>
								</div>
							</div>
						</div>
