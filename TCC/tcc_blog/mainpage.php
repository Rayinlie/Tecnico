...
<div class="page-wrapper chiller-theme toggled">
    ...
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          ...
          <span class="user-role"><?php echo "Usuário"; ?></span>
  ...
  <!-- sidebar-wrapper  -->
  <div class="page-content bg-white" id="conteudo-pagina-lida">
<div class="batata">
<div class="row">
<div class="col-12">
    <div class="row">
        ...
        <div class="col-8">
            <h1 class="text-dark">Postagens Recentes</h1>
            <br><br><br>
        </div>
    </div>
</div>
    ...
    <div class="col-12">
        ...
        <div class="col-1"></div>
            ...
            <?php
                ...
                $cmd = $registro_post->getListaPost(); 
                ...
                $cmd = $registro_post->getListaPaginaPost($inicio,$registros); 
                
                $total = mysqli_num_rows($cmd); 
                while ($reg_post = mysqli_fetch_array($cmd)) { 
     ?>

<div class="card rounded border-primary" style="width: 18rem;">
  <div class="card-body">
...
<a class="btn btn-primary" href="trtrtr.php?idpost=<?php echo $reg_post[0]?>">Post Completo</a>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo $reg_post[1]; ?></h5>
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
              ...
              <div class="row">   
                ...
                for($i = 1; $i < $numPaginas + 1; $i++) { 
                      ...
                      <?php
                        echo "<a class='btn btn-primary' href='mainpage.php?pagina=$i'>".$i."</a> "; 
                    } 
                    ?>
                    </div>
                </div>
