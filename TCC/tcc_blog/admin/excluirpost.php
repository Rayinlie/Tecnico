...
?>
    ...
    <body class="bg-white" style="background-image:url('../img/bg-1.jpg');">
...
<div class="row">
<div class="col-3"></div>
<div class="col-6 border-dark rounded bg-white">
    <h1 class="text-dark" >Deseja excluir o post de: <?php echo $buscando[1]; ?></h1>
    <div class="row">
        <div class="col-5">
