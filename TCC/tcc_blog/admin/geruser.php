...
<table class="table-responsive table-white bg-white">
    ...
    <tr class="table-white bg-white">
        <td class="m-1"><button class="btn-primary btn btn-md mx-1"><a id="nomeuser" class="btn-primary btn btn-md" href="#">Buscar Usuário pelo Nome</a></button></td>
        <td class="m-1"><button class="btn-primary btn btn-md mx-1"><a id="useremail" class="btn-primary btn btn-md" href="#">Buscar Usuário pelo Email</a></button></td>
        <td class="m-1"><button class="btn-primary btn btn-md mx-1"><a href="allusers.php" class="btn-primary btn btn-md" href="#">Lista de Todos os Usuários</a></button></td>
        <td class="m-1"><button class="btn-primary btn btn-md mx-1"><a href="mensagens.php" class="btn-primary btn btn-md" href="#">Lista de Mensagens</a></button></td>
