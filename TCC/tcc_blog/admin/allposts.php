...
<div class="page-wrapper chiller-theme toggled">
  ...
  <h1 class="text-dark mt-2" style="padding-left:30%;"> Todos as Postagens</h1>
  <?php


    $busca = $registro_post->getlistaPost();
...
<td><a href="excluirpost.php?id_post=<?php echo $buscar[0];?>" class="btn btn-primary" type="submit" name="excluir">Excluir</a></td>
</tr>
