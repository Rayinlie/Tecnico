...
<div class="container-fluid">
		<div class="container">
			<div class="formBox">
				<form method="POST" action="msgn.php">
						<div class="row">
							<div class="col-sm-12">
								<h1 class="text-dark">Contatar um Administrador</h1>
                                <br><br><br>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
							<div class="inputText text-muted h4"> Titulo da Mensagem</div>
								<div class="inputBox ">
							...
							<div class="col-sm-6">
							<div class="inputText text-muted h4">Referências(Opcional)</div>
						...
						<div class="row">
							<div class="col-sm-12">
							<div class="inputText text-muted h4">Mensagem</div>
								<div class="inputBox text-dark">
						...
						<div class="row">
							<div class="col-sm-12">
								<input type="submit" name="Enviar" class="button rounded" value="Enviar">
							</div>
						</div>
				</form>
			</div>
