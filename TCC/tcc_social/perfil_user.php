...
<div class="form-group col-md-6">
    ...
    <span class="col-md-6 w-100 ">
          <img class="img-responsive img-rounded border border-dark" src="img/<?php echo $nomedousuario;?>.png"
            alt="User picture">
    </span>
        </div>
    </div>
...
<a href="alteraruser2.php?id_user=<?php echo $listagem_user[0]; ?>" class="btn btn-primary">Alterar</a>
