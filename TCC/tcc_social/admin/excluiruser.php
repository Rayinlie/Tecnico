...
<?php
    ...
    $busquei = $registro_user->buscarUser($codigo);
?>
    <head>
    <meta charset="UTF-8">
...
<div class="col-3"></div>
<div class="col-6">
    <h1 class="text-white" >Deseja EXCLUIR o Usuário: <?php echo $busquei[1]; ?></h1>
    <div class="row">
        <div class="col-5">
...
if(isset($_POST['ctz'])){
    ...
    header("Refresh: 2; url = geruser.php");
}
if(isset($_POST['non'])){
    header("location: geruser.php");
