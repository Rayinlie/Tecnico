...
<div class="page-wrapper chiller-theme toggled">
  ...
  <?php
    ...
    $busca = $registro_msgn->getlistaMsgn();
...
<tr>
<?php    while($buscar = mysqli_fetch_array($busca)){
?>
<td><?php echo $buscar[0];?></td>
<td><?php echo $buscar[1];?></td>
<td><?php
 $buscauser = $registro_user->buscarUser($buscar[2]);
 echo $buscauser[1];
 ?></td>
<td><?php echo substr($buscar[3],0,30);?></td>
<td><a href="excluirmsgn.php?id_msgn=<?php echo $buscar[0];?>" class="btn btn-primary" type="submit" name="excluir">Excluir</a></td>
<td><a href="respondermsgn.php?id_msgn=<?php echo $buscar[0];?>" class="btn btn-primary" type="submit" name="excluir">Responder</a></td>
</tr>
