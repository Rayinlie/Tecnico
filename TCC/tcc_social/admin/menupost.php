...
<table class="table-responsive table-dark bg-dark">
    ...
    <tr class="table-dark">
        <td class=""><button class="btn-primary btn btn-md"><a id="tituloposts" class="btn-primary btn btn-md" href="#">Buscar Post pelo Titulo</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a id="userposts" class="btn-primary btn btn-md" href="#">Buscar Post pelo Usuário</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a id="tagposts" class="btn-primary btn btn-md" href="#">Buscar Post pela Tag</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a href="allposts.php" class="btn-primary btn btn-md" href="#">Lista de Todos os Posts</a></button></td>
        </tr>
    <br><br>
