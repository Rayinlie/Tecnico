...
<table class="table-responsive table-dark bg-dark">

    <tr class="table-dark bg-dark">
        <td class=""><button class="btn-primary btn btn-md"><a id="nomeuser" class="btn-primary btn btn-md" href="#">Buscar Usuário pelo Nome</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a id="useremail" class="btn-primary btn btn-md" href="#">Buscar Usuário pelo Email</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a href="allusers.php" class="btn-primary btn btn-md" href="#">Lista de Todos os Usuários</a></button></td>
        <td class=""><button class="btn-primary btn btn-md"><a href="mensagens.php" class="btn-primary btn btn-md" href="#">Lista de Mensagens</a></button></td>
